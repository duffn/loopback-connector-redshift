...
function mixinMigration(Redshift) {
  /*!
   * Discover the properties from a table
   * @param {String} model The model name
   * @param {Function} cb The callback function
   */
  Redshift.prototype.getTableStatus = function(model, cb) {
    var fields;
    ...
    function decoratedTableDataCallback(err, data) {
      ...
      if (!err) {
        data.forEach(function(field) {
          field.type = mapRedshiftDatatypes(field.type, field.length);
        });
      }
      fields = data;
      done(err);
   ...
   */
  Redshift.prototype.autoupdate = function(models, cb) {
    var self = this;
   ...
   * @param {Function} [cb] The callback function
   */
  Redshift.prototype.isActual = function(models, cb) {
    var self = this;
   ...
   * @param {Function} [cb] The callback function
   */
  Redshift.prototype.alterTable = function(model, actualFields, actualIndexes, cb) {
    var self = this;
  ...
  Redshift.prototype.getAddModifyColumns = function(model, actualFields) {
    var sql = [];
    var self = this;
  ...
  Redshift.prototype.getDropColumns = function(model, actualFields) {
    var sql = [];
    var self = this;
  ...
  Redshift.prototype.getColumnsToAdd = function(model, actualFields) {
    var self = this;
  ...
  Redshift.prototype.addPropertyToActual = function(model, propName) {
    var self = this;
  ...
  Redshift.prototype.searchForPropertyInActual = function(model, propName, actualFields) {
    var self = this;
    var found = false;
  ...
  Redshift.prototype.getPropertiesToModify = function(model, actualFields) {
    var self = this;
    var sql = [];
    var m = self._models[model];
    var propNames = Object.keys(m.properties);
  ...
  Redshift.prototype.modifyDatatypeInActual = function(model, propName) {
    var self = this;
  ...
  Redshift.prototype.modifyNullabilityInActual = function(model, propName) {
    var self = this;
  ...
  Redshift.prototype.getColumnsToDrop = function(model, actualFields) {
    var self = this;
    var sql = [];
  ...
  Redshift.prototype.applySqlChanges = function(model, pendingChanges, cb) {
    var self = this;
    if (pendingChanges.length) {
   ...
   * @returns {String}
   */
  Redshift.prototype.buildColumnDefinitions =
    Redshift.prototype.propertiesSQL = function(model) {
      var self = this;
      var sql = [];
   ...
   * @returns {*|string}
   */
  Redshift.prototype.buildColumnDefinition = function(model, propName) {
    var self = this;
    var modelDef = this.getModelDefinition(model);
    var prop = modelDef.properties[propName];
    if (prop.id && prop.generated) {
      // No SERIAL datatype in Redshift, but this is the equivalent
   ...
   * @param {Function} [cb] The callback function
   */
  Redshift.prototype.createTable = function(model, cb) {
    var self = this;
    var name = self.tableEscaped(model);

    // Redshift currently supports IF NOT EXISTS for schemas
   ...
   */
  Redshift.prototype.columnDbDefault = function(model, property) {
   ...
   */
  Redshift.prototype.columnDataType = function(model, property) {
    var columnMetadata = this.columnMetadata(model, property);
    ...
    switch (prop.type.name) {
      ...
      case 'Point':
        return 'POINT';
      case 'Boolean':
        return 'BOOLEAN'; // Redshift doesn't have built-in boolean
    }
  };
  ...
  function mapRedshiftDatatypes(typeName, typeLength) {
  ...
  Redshift.prototype.propertyHasNotBeenDeleted = function(model, propName) {
    return !!this.getModelDefinition(model).properties[propName];
  };

  Redshift.prototype.addIndexes = function(model, actualIndexes, cb) {
    var self = this;
    var m = self._models[model];
    var propNames = Object.keys(m.properties).filter(function(name) {
